        ...
        <g id="首页" transform="translate(-68.000000, -88.000000)">
          <g id="Illustrator" transform="translate(68.000000, 88.000000)">
            ...
            <g id="i4" transform="translate(337.000000, 0.000000)">
              ...
              <TweenOne
                component="g"
                animation={{ ...animate.loop, y: 5, delay: delay + duration + 200 }}>
                <TweenOne
                  component="g"
            ...
            <g id="i3" transform="translate(0.000000, 45.000000)">
              ...
              <TweenOne
                component="g"
                animation={{ ...animate.loop, y: -10, delay: delay + duration + 200 }}>
                ...
                <g id="dian" transform="translate(286.000000, 69.000000)">
                  ...
                  <TweenOne
                    component="g"
                    animation={{ delay: delay + 600, ...animate.yBig, ease: 'easeOutBounce' }}>
                    <path
            ...
            <g id="i1" transform="translate(42.000000, 248.000000)">
              ...
              <TweenOne
                component="g"
                animation={{ ...animate.loop, y: 15, delay: delay + duration + 200 }}>
                <TweenOne
                  component="g"
                  animation={{ delay, ...animate.yBig }}
                  id="Group-21"
